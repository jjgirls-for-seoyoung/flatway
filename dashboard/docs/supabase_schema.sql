...
-- Seed Hazards
INSERT INTO hazards (type, latitude, longitude, step_height_cm, severity, description, is_verified)
VALUES 
  ('step', 37.5349, 126.7224, 4.5, 'high', '작전역 4번 출구 앞 보도 경계석 단차가 높아 휠체어 진입 불가', true),
  ('damage', 37.5365, 126.7235, NULL, 'medium', '작전여고 통학로 보도블록 파손 및 요철 심함', true),
  ('obstacle', 37.5358, 126.7218, NULL, 'high', '횡단보도 앞 불법 주차 차량 및 자전거 적치물로 시야 확보 불가 및 통행 방해', false),
  ('slope', 37.5372, 126.7245, NULL, 'low', '주택가 이면도로 경사 다소 급함 (수동 휠체어 이용 시 주의 요함)', true);
